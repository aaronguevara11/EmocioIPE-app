...
class Comunicacion extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: PageView(
        children: [
          ...
          _buildImage1('assets/img/modulo2/5.png', context),
          _buildImage1('assets/img/modulo2/6.png', context),
  ...
  Widget _buildImage1(String assetPath, BuildContext context) {
    return SizedBox(
        width: MediaQuery.of(context).size.width,
        height: MediaQuery.of(context).size.height,
        child: Align(
    ...
    return Scaffold(
      ...
      body: PageView(
        children: [
          ...
          _buildImage1('assets/img/modulo2/18.png', context),
          _buildImage1('assets/img/modulo2/19.png', context),
    ...
    return Scaffold(
      ...
      body: PageView(
        children: [
          ...
          _buildImage1('assets/img/modulo2/24.png', context),
