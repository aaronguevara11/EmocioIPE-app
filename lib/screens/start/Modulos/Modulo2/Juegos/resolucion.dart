...
class _Historia2State extends State<Historia2> {
  ...
  Color _getOptionColor(int option) {
    ...
    if (option == 3) {
      return const Color.fromARGB(255, 115, 220, 118); // Verde para la correcta
    } else if (option == selectedOption) {
      return const Color.fromARGB(
          255, 225, 101, 92); // Rojo para la incorrecta seleccionada
    } else {
      return const Color.fromARGB(
          255, 201, 224, 243); // Color base para las demás
    }
  }
