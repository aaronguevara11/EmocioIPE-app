...
class TerceraRespuestaActua extends StatefulWidget {
  final int idNivel;
  const TerceraRespuestaActua({super.key, required this.idNivel});

  @override
  State<TerceraRespuestaActua> createState() => _TerceraRespuestaActuaState();
}

class _TerceraRespuestaActuaState extends State<TerceraRespuestaActua> {
