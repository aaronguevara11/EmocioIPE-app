...
class PrimeraRespuestaActua extends StatefulWidget {
  final int idNivel;
  const PrimeraRespuestaActua({super.key, required this.idNivel});

  @override
  State<PrimeraRespuestaActua> createState() => _PrimeraRespuestaActuaState();
}

class _PrimeraRespuestaActuaState extends State<PrimeraRespuestaActua> {
